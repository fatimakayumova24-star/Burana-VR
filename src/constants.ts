...
export const SITE_CONTENT = {
  ...
  historyParagraphs: [
    ...
    "It has been also concluded that the balbals developed later into memorials to the ancestors that are described by detailed carvings of faces and hands. Balbals give us an insight into the clothes, jewelry, and weaponry of our ancestors. Archeologists believe that people carved swords on a statue describing a person who was a fighter or a man of power such as a tribe leader. A large portion of these statues are also carrying a dish as the people wanted to make sure that the deceased one would not need to suffer from hunger. Balbal statues are believed to have originated between the 6th and 10th centuries.",
