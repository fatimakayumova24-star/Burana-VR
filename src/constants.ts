...
export const HISTORY_INFO = {
  ...
  attributes: "Stone statues The face is masculine, some are feminine, modern, holomorphic. Several are wearing a three-horned headdress. There are pendant earrings. These balbals were found in the Shaymshi mountains of Shaymshi village, Alga village, Chui district. Most balbals have moon-shaped eyebrows, mendal-shaped eyes, long and inward noses, and prominent mouths. Many balbals had hands shaped like scissors. Some have heads drawn with lines. Mostly length 40-48, 21-28, and width 16-19, 21-23, 34-35, height 64-70, 94-110, 80-86."
};
